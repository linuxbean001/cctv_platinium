...
function FinalCart() {
  ...
  const imgUrl_2 =
    "https://plus.unsplash.com/premium_photo-1675016457613-2291390d1bf6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80";
  const imgUrl_3 =
    "https://images.unsplash.com/photo-1600069620961-8bee77c2e28a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=773&q=80";
            ...
            <div className="col-md-7 cart" style={{ backgroundColor: "" }}>
              ...
              <div className="row border-top border-bottom">
                <div className="row main align-items-center py-4">
                  <div className="col-2">
                    <img className="img-fluid" src={imgUrl_1} />
                  </div>
                  <div className="col">
                    <div className="row text-muted fs-6 fw-bold">
                      Security Camera
                    </div>
              ...
              <div className="row">
                <div className="row main align-items-center py-4">
                  <div className="col-2">
                    <img className="img-fluid" src={imgUrl_2} />
                  </div>
                  <div className="col">
                    <div className="row text-muted fs-6 fw-bold">
                      Home CCTV{" "}
              ...
              <div className="row border-top border-bottom">
                <div className="row main align-items-center py-4">
                  <div className="col-2">
                    <img className="img-fluid" src={imgUrl_3} />
                  </div>
                  <div className="col">
                    <div className="row text-muted fs-6 fw-bold">
                      NVR Recorders
