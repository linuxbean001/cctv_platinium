...
function Pdf() {
  ...
  console.log("selectedNVR", Nvr);
  console.log("selectedCamera", camera);
  console.log("selectedCabling", cabling);
  console.log("selectedLabor", labor);
  console.log("selectedPoE", poe);
  console.log("selectedHardWare", hard);
    ...
    <div className="p-3">
      ...
      <div id="tableToConvert">
          ...
          <div className="border border-indigo-600 mt-5">
            <Container fluid
              style={{backgroundColor: "#21252938"}}
            >
              <h2>Platinum CCTV</h2>
            </Container>
            <div>
